...
console.log("toNamesp  ", "C:/foo               ", path.toNamespacedPath("C:/foo"))
console.log("toNamesp  ", "C:                   ", path.toNamespacedPath("C:"))
console.log("toNamesp  ", "\\\\server\\share      ", path.toNamespacedPath("\\\\server\\share"))
console.log("toNamesp  ", "\\\\?\\C:\\foo         ", path.toNamespacedPath("\\\\?\\C:\\foo"))
console.log("toNamesp  ", "relative             ", path.toNamespacedPath("relative"))
console.log("toNamesp  ", "foo\\bar             ", path.toNamespacedPath("foo\\bar"))
console.log("toNamesp  ", "(empty)              ", path.toNamespacedPath(""))
console.log("toNamesp  ", "(non-string 123)     ", path.toNamespacedPath(123))
console.log("toNamesp  ", "posix /foo           ", path.posix.toNamespacedPath("/foo"))

...
assert(s.at(99) === undefined, "at OOB")
assert(s.charAt(0)!.toString() === "H", "charAt(0)")
assert(s.charAt(99) === undefined, "charAt OOB")
assert(s.charCodeAt(0) === 72, "charCodeAt(0)")
assert(isNaN(s.charCodeAt(99)), "charCodeAt OOB")
assert(s.codePointAt(0) === 72, "codePointAt(0)")
assert(isNaN(s.codePointAt(99)), "codePointAt OOB")
